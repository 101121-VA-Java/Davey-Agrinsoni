...
//		Task[] taskArr = {t1 , null, null};
	...
	public void doPolymorphism() {
		...
		System.out.println("Due date before all: " + bt.getDate());

		bt.procrastinate();

		System.out.println("Due date after procrastinate(): " + bt.getDate());

		bt.procrastinate(5);

		System.out.println("Due date after procrastinate(5): " + bt.getDate());

		bt.procrastinate(5, 2);

		System.out.println("Due date after procrastinate(5, 2): " + bt.getDate());
